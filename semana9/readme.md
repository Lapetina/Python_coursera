...
No nosso caso, o texto bb não é conhecido, mas temos a assinatura correspondente: a assinatura de um aluno infectado com COH-PIAH.
...
Se soma os resultados dos 6 traços linguísticos (\sum_{i=1}^6∑ 
i=1
6
​	 )

E por final se divide por 6 ( \frac{x}{6} 
6
x
​	 )
